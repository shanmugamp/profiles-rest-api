...
PROJECT_GIT_URL='https://github.com/shanmugamp/profiles-rest-api.git'
...
virtualenv  $VIRTUALENV_BASE_PATH/profiles-api

source $VIRTUALENV_BASE_PATH/profiles-api/bin/activate
...
supervisorctl restart profiles-api
